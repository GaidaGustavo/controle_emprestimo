...
class UsuarioRepositoryMemory {
    constructor() {
        ...
        this.usuarios = [
            new usuario_1.Usuario('jacson_santos', pessoa1, '123', '7e461e53-0793-4ba3-8c34-dc5f45481b31'),
            new usuario_1.Usuario('gabriel_anel', pessoa2, '123', '3b4596dd-45d4-4f0e-ac57-d7e18d46fdfe')
        ];
    }
    getAll() {
