...
export class ItemRepositoryMemory implements ItemRepository {
    ...
    constructor() {
        ...
        this.itens = [
            new Item('Copo de Café', 'eb51e356-16c1-4b1e-bfea-aadc07a2c60c', tipoItem1),
            new Item('Copo de Agua', 'ef887170-3137-4d5e-89f7-cae4279720e6', tipoItem1 ),
            new Item('Computador desktop dell', '63867047-bb25-468d-932a-8d471401a5c4', tipoItem2)
        ]
    }
